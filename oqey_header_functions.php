<?php
if (!empty($_SERVER['SCRIPT_FILENAME']) && 'oqey_header_functions.php' == basename($_SERVER['SCRIPT_FILENAME'])) die ('Please do not load this page directly. Thanks!');
global $wpdb;
...
$images = $wpdb->get_results(" SELECT * FROM $oqey_header WHERE oqey_h_exclude !=1 ORDER BY oqey_h_order ASC ");
...
$r_image = $wpdb->get_results(" SELECT * FROM $oqey_header WHERE oqey_h_exclude !=1 ORDER BY Rand() LIMIT 1 ");
